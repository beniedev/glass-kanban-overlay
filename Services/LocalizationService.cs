...
public static class LocalizationService
{
    ...
    private static readonly Dictionary<string, Dictionary<string, string>> Dictionaries = new(StringComparer.OrdinalIgnoreCase)
    {
        ...
        ["zh-Hant"] = WithEnglish(
            ...
            ("Action.OpenSource", "開啟原 Markdown 檔案"),
            ("Action.BoardMenu", "看板操作"),
            ("Action.ConfigureWindow", "設定視窗"),
            ("Action.RemoveBoard", "移除看板"),
        ...
        ["ja"] = WithEnglish(
            ...
            ("Action.BoardMenu", "ボード操作"),
            ("Action.ConfigureWindow", "ウィンドウを設定"),
            ("Action.RemoveBoard", "ボードを外す"),
        ...
        ["ko"] = WithEnglish(
            ...
            ("Action.BoardMenu", "보드 작업"),
            ("Action.ConfigureWindow", "창 설정"),
            ("Action.RemoveBoard", "보드 제거"),
